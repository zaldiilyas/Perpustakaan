...
{
    // Ambil objek buku sesuai dengan request
    $book = Books::findOrFail($request->id);

    // Ambil semua ulasan untuk buku yang dipilih
    $ulasans = Ulasan::with('user')->where('book_id', $book->id)->get();

    // Kemudian lewatkan data buku dan ulasan ke view
