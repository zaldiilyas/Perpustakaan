...
Route::post('/bookKomen', [BookController::class, 'store'])->middleware('auth');
...
Route::resource('/bukuFavorit', FavoritController::class)->middleware('auth');
Route::post('/bukuFavorit', [FavoritController::class, 'store'])->middleware('auth');
Route::delete('/bukuFavorit/{id}', [FavoritController::class, "destroy"])->middleware('auth');
